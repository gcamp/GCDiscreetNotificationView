...
- (void) layoutSubviews {
    ...
    CGFloat textSizeWidth = (self.textLabel != nil) ? 0 : [self.textLabel sizeWithFont:self.label.font constrainedToSize:maxLabelSize lineBreakMode:UILineBreakModeTailTruncation].width;
